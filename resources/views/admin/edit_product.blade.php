        ...
        <div class="wrap-contact100">
            ...
            <form class="contact100-form validate-form" action="{{url('/update-product/'.$pro->product_id)}}" method="POST" enctype="multipart/form-data">
                ...
                <div class="wrap-input100 validate-input bg1 rs1-wrap-input100" data-validate="Chưa nhập giá sản phẩm">
                    ...
                    <input class="input100" type="number" name="product_price" min="1000" value="{{$pro->product_price}}">
                </div>
                <div class="wrap-input100 validate-input bg1 rs1-wrap-input100" data-validate="Chưa nhập khuyến mại">
                    ...
                    <input class="input100" type="number" name="product_discount" min="0" max="100" value="{{$pro->product_discount}}">
                </div>
