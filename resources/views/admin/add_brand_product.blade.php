...
<section class="wrapper">
    <div class="container-contact100">
        <div class="wrap-contact100">
            <form class="contact100-form validate-form" action="{{url('/save-brand-product')}}" method="POST">
                @csrf
                ...
                ?>
                <div class="wrap-input100 validate-input bg1" data-validate="Chưa nhập tên thương hiệu">
                    <span class="label-input100">Thương hiệu</span>
                    <input class="input100" type="text" name="brand_product_name">
                </div>
                ...
                <div class="wrap-input100 validate-input bg0 rs1-alert-validate" data-validate = "Chưa nhập mô tả">
                    ...
                    <textarea class="input100 txtarea" name="brand_product_desc"></textarea>
                </div>
