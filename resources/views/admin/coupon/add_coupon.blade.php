...
@include('admin.pages.style_form_adding')
    ...
    <div class="container-contact100">
        <div class="wrap-contact100">
            <form class="contact100-form validate-form" action="{{url('/add-coupon-code')}}" method="POST">
                @csrf
                ...
                <div class="wrap-input100 validate-input bg1" data-validate="Chưa số lượng sử dụng">
                    ...
                    <input class="input100" type="number" name="coupon_time">
                </div>
                ...
                <div class="w-full dis-none js-show-service">
                    ...
                    <input class="input100" type="number" name="coupon_number">
                </div>
                </div>
