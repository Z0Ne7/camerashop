...
class ProductController extends Controller
{
    ...
    public function details_product($product_id)
    {
        ...
        foreach ($product_details as $product_detail) {
            ...
            $discount_amount = $product_detail->product_price * $product_detail->product_discount / 100;
            $product_discount_price = $product_detail->product_price - $discount_amount;
        }
        ...
        return view('pages.product.show_details')->with('category', $cate_product)->with('brand', $brand_product)
            ->with(compact('product_details', 'relate', 'count_relate', 'lastest', 'product_discount_price'));
    }
